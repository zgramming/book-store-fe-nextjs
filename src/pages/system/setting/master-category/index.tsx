...
import { Badge, Button, Card, Flex, Grid, Group, LoadingOverlay, Stack, Table, TextInput } from '@mantine/core';
...
export default function Page() {
  ...
  const onAddButton = () => {
    push({
      pathname: 'master-category/form/new',
    });
  };

  const onEditButton = (id: string) => {
    push({
      pathname: `master-category/form/${id}`,
    });
  };

  const onDeleteHandler = async (id: string) => {
    try {
      await MasterCategoryRepository.api.delete(id);
      notifications.show({
        title: 'Success',
        color: 'green',
